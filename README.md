...
- **Scraping**: [Playwright](https://playwright.dev/) (Chromium) — handles the client-rendered grids on Bazaraki/Altamira/Zyprus/BuySellCyprus/home.cy/FOX Realty; eAuction, Realting and A Place in the Sun use plain `fetch` against server-rendered HTML / XHR endpoints
